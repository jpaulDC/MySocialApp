...
import {
    getReels, toggleReelLike, getReelComments,
    addReelComment, deleteReel,
    Reel, ReelComment
...
export default function ReelsScreen() {
    ...
    const loadReels = useCallback(async (pageNum = 1, refresh = false) => {
        try {
            ...
            setReels(prev => refresh || pageNum === 1 ? data : [...prev, ...data]);
        ...
        return (
            <View style={styles.reelContainer}>
                ...
                <Video
                    ...
                    shouldPlay={isActive}   // Only play the visible reel
